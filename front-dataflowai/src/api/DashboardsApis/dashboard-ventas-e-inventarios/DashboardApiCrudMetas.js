...
const BASE = `${API_BASE_URL}DashVeinte/Metas/`;
const BASE_TIENDAS = `${API_BASE_URL}tiendas/`;
const BASE_PRODUCTOS = `${API_BASE_URL}DashVeinte/Prodcutos/`; // si usaste esa ruta para productos

export const fetchDashVeinteMetas = async (params = {}) => {
...
export const fetchDashVeinteMeta = async (id) => {
...
export const createDashVeinteMeta = async (payload) => {
...
export const updateDashVeinteMeta = async (id, payload, usePut = false) => {
...
export const deleteDashVeinteMeta = async (id) => {
