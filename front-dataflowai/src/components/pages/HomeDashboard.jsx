...
export const HomeDashboard = () => {
  ...
  // NUEVOS ESTADOS PARA FILTROS POR ÁREA
  ...
  useEffect(() => {
    ...
    // Cerrar sugerencias y filtros al hacer clic afuera
  ...
  // NUEVA función para manejar la selección de áreas
  ...
  // NUEVAS FUNCIONES para obtener áreas únicas y agrupar productos
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.heroSection}>
        {usuario && (
          <div className={styles.heroContent}>
            ...
            {/* <-- CAMBIO: usar nombre_corto en lugar de nombre (fallback a nombre si nombre_corto no existe) */}
      ...
      <div className={styles.mainContent}>
        ...
        {/* NUEVA ESTRUCTURA: Cards agrupadas por área */}
